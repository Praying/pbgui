...
.fs-ts { color: #64748b; font-size: var(--fs-xs); }
.fs-note { color: #4a5568; padding: 0.5rem; font-style: italic; }
...
.pm-note { color: #4a5568; padding: 0.5rem; font-style: italic; }
