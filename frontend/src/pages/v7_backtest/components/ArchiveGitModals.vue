  ...
  <div v-if="git.pullOpen.value" id="modal-root" :class="modalBackdropClass" data-test="archive-pull-progress-modal">
    ...
    >
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.hidePull()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
  ...
  <div v-if="git.pullResults.value" id="modal-root" :class="modalBackdropClass" data-test="archive-pull-results">
    <div :class="[modalBoxClass, 'shadow-modal']">
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.closePullResults()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
      <div class="min-h-0 flex-1 overflow-auto">
  ...
  <div v-if="git.pushOutput.value" id="modal-root" :class="modalBackdropClass" data-test="archive-push-output">
    <div :class="[modalBoxClass, 'shadow-modal']">
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.closePushOutput()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
  ...
  <div v-if="git.compactPreview.value" id="modal-root" :class="modalBackdropClass" data-test="archive-compact-preview">
    <div :class="modalBoxClass">
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.closeCompactPreview()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
      <div class="min-h-0 flex-1 overflow-auto">
        ...
        <div class="my-2 rounded-md border border-white/12 bg-white/4 p-2">
          <div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitEstimatedSavings') }}</div>
          ...
          <div class="form-row cols-2">
            <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitBefore') }}</div><b>{{ git.compactPreview.value.view.before }}</b></div>
            <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitAfterCompact') }}</div><b>{{ git.compactPreview.value.view.after }}</b></div>
          </div>
          <p class="mt-1 text-secondary">{{ git.compactPreview.value.view.note }}</p>
        </div>
        <div class="form-row cols-2">
          <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitArchive') }}</div><b>{{ git.compactPreview.value.name }}</b></div>
          <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitBranch') }}</div><b>{{ git.compactPreview.value.view.branch }}</b></div>
        </div>
        <div class="form-row cols-2">
          <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitCommitCount') }}</div><b>{{ git.compactPreview.value.view.commitCount }}</b></div>
          <div><div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitManifestItems') }}</div><b>{{ git.compactPreview.value.view.manifestItems }}</b></div>
        </div>
        <div class="text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitPendingLocalChanges') }}</div>
        ...
        <div class="mt-2 text-xs uppercase tracking-label text-secondary">{{ t('v7backtest.gitObjectSize') }}</div>
  ...
  <div v-if="git.compactOutput.value" id="modal-root" :class="modalBackdropClass" data-test="archive-compact-output">
    <div :class="modalBoxClass">
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.closeCompactOutput()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
  ...
  <div v-if="git.setupOpen.value" id="modal-root" :class="modalBackdropClass" data-test="archive-setup">
    <div :class="modalBoxClass">
      <div class="mb-3 flex shrink-0 items-center justify-between border-b border-border-default pb-2">
        ...
        <Button type="button" variant="ghost" class="h-auto border-0 px-2 py-0.5 text-lg text-secondary hover:bg-white/10 hover:text-primary" :title="t('common.close')" :aria-label="t('common.close')" @click="git.closeSetup()"><PbIcon :icon="PhX" :size="18" /></Button>
      </div>
      <div class="min-h-0 flex-1 overflow-auto">
