...
<template>
  ...
  <div ref="toastEl" id="toast" role="status" aria-live="polite" class="fixed bottom-5 right-5 z-[var(--z-toast)] rounded-md px-5 py-2 text-sm font-semibold transition-opacity duration-300"></div>
