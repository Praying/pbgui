...
<template>
  <div :id="plotId" ref="el" class="plot h-[520px] min-h-[360px] overflow-hidden rounded-xl border border-secondary/14 bg-page/74 shadow-[var(--shadow-panel)] [content-visibility:auto] [contain-intrinsic-size:520px] max-[1250px]:h-[420px] max-[640px]:h-[360px] max-[640px]:min-h-[300px]"></div>
</template>
