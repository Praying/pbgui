...
const legend = computed(() => [
  { style: 'do-leg-solid', color: '#a0aec0', label: dashT('dash.entry', 'Entry') },
  { style: 'do-leg-dotted', color: '#a0aec0', label: dashT('dash.price', 'Price') },
  { style: 'do-leg-dashed', color: '#48bb78', label: dashT('dash.buyOrder', 'Buy Order') },
  { style: 'do-leg-dashed', color: '#f56565', label: dashT('dash.sellOrder', 'Sell Order') },
]);
