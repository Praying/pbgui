...
export const dtRootClass =
  'dt-root relative overflow-hidden rounded-md bg-page font-sans text-compact text-primary';

/** `.di-root` adds the column flex chain (it hosts the scrollable table). */
export const diRootClass =
  'di-root relative flex w-full flex-col overflow-hidden rounded-md bg-page font-sans text-compact text-primary';
...
export const dtTitleClass =
  'dt-title shrink-0 whitespace-nowrap text-compact font-semibold text-accent-soft';

/** `.dt-icon` */
export const dtIconClass = 'dt-icon shrink-0 text-compact leading-none';
...
export const dtTrashClass =
  'dt-trash ml-[0.25rem] size-[22px] shrink-0 p-0 text-compact leading-none text-muted hover:bg-danger-soft/10 hover:text-danger-soft';

/** `.dt-meta` */
export const dtMetaClass = 'dt-meta ml-auto whitespace-nowrap text-micro text-secondary';
...
export const dtMetaLblClass =
  'dt-meta-lbl shrink-0 whitespace-nowrap text-micro text-secondary';

/** `.dt-meta-sep` */
export const dtMetaSepClass =
  'dt-meta-sep shrink-0 px-[0.1rem] text-micro text-border-strong';
...
export const dtCtrlNowWrapClass =
  'dt-ctrl-now-wrap flex shrink-0 cursor-pointer select-none items-center gap-[0.25rem] whitespace-nowrap text-micro text-secondary';
...
export const dtDaterangeClass =
  'dt-daterange min-h-[1.1em] border-b border-b-card bg-page px-[0.75rem] py-[0.2rem] text-micro text-muted';
...
export const dpModalChrome = {
  ...
  /** `.dp-modal-title` */
  title: 'dp-modal-title text-compact font-bold text-primary',
  /** `.dp-modal-close` — rendered by ui/Button (ghost); the constant keeps
   *  the legacy hook class plus the glyph sizing. */
  close: 'dp-modal-close px-[0.35rem] py-0 text-base leading-none text-muted hover:text-primary',
  /** `.dp-modal-body` */
  ...
  statusMsg: 'dp-status-msg min-h-[1.2em] text-micro leading-[1.4] text-secondary',
};
