...
<template>
  ...
  <div class="form-row cols-8">
    ...
    <div class="form-group" style="justify-content: flex-end">
      <FieldCheck id="f-apply-filters" v-model="state.applyFilters" label="apply_filters" tip="Enable PBGui coin filters. When unchecked all filters above are ignored." />
    </div>
  </div>
  ...
  <!-- Dynamic Ignore (v7-only; preview arrives with M-v7-2) -->
