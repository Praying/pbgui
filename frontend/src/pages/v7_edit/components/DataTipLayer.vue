...
<template>
  <div
    ref="tip"
    id="data-tip-tooltip"
    class="pointer-events-none fixed z-[var(--z-tooltip)] max-w-[480px] rounded-[5px] border border-border-strong bg-card px-2.5 py-1.5 text-xs font-normal leading-[1.5] text-primary whitespace-pre-wrap shadow-[0_4px_12px_rgba(5,8,14,0.5)]"
