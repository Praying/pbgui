/*
 * The page toast (v7_edit.html:1314-1331 (toast)): shows the message for 8 s with a
...
/** Kind → Tailwind colour utilities (the former .toast-ok/.toast-err/
 *  .toast-info rules). The static positioning utilities on the toast
 *  element stay untouched — classes are added, never replaced. */
...
/** Notify-log mirror (:1315-1320) — best effort, never surfaces errors. */
