...
/**
 * Live log terminal for queue log dialogs — shared component for optimize and
 * backtest task log streams:
 *
 ...
 *     / Restart-Stop / Traceback) as single-select regex filters
