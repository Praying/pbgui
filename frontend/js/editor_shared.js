  ...
  function ensureFixedValidationOverlay() {
    ...
    if (!style) {
      ...
      style.textContent = [
        ...
        '#pb-json-fixed-validation .pb-json-fixed-meta{margin-top:4px;color:#ee8d84}',
