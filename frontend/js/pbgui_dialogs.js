(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '#pbgui-dialog-box{background:#131b2b;border:1px solid #37333a;border-radius:14px;box-shadow:0 20px 70px rgba(0,0,0,.9);overflow:hidden;width:min(480px,92vw);max-width:92vw;}',
      '#pbgui-dialog-header{display:flex;justify-content:space-between;align-items:center;gap:var(--sp-sm);padding:.85rem 1.1rem;border-bottom:1px solid #29262c;background:#171619;}',
      '#pbgui-dialog-title{font-size:var(--fs-md);font-weight:700;color:#eae7ea;}',
      '#pbgui-dialog-close{background:transparent;border:none;color:#716b75;font-size:var(--fs-lg);cursor:pointer;padding:.2rem .35rem;border-radius:5px;line-height:1;}',
      '#pbgui-dialog-close:hover{color:#eae7ea;background:rgba(255,255,255,.06);}',
      '#pbgui-dialog-body{display:grid;gap:var(--sp-md);padding:var(--sp-lg);}',
      '#pbgui-dialog-message{font-size:var(--fs-base);line-height:1.5;color:#eae7ea;white-space:pre-wrap;}',
      '#pbgui-dialog-detail{font-size:var(--fs-sm);line-height:1.45;color:#a29ca6;white-space:pre-wrap;}',
      ...
      '#pbgui-dialog-input{width:100%;height:var(--input-h);padding:0 var(--sp-sm);border-radius:8px;border:1px solid #37333a;background:#0f172a;color:#eae7ea;font-size:var(--fs-base);outline:none;}',
      ...
      '.pbgui-dialog-btn.secondary{background:rgba(99,179,237,.08);border-color:rgba(99,179,237,.25);color:#eae7ea;}',
