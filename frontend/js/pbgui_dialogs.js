(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '#pbgui-dialog-box{background:#171c29;border:1px solid #333f5c;border-radius:14px;box-shadow:0 20px 70px rgba(5, 8, 14,.9);overflow:hidden;width:min(480px,92vw);max-width:92vw;}',
      ...
      '#pbgui-dialog-message{font-size:var(--fs-base);line-height:1.5;color:#e8ecf4;white-space:pre-wrap;}',
      '#pbgui-dialog-detail{font-size:var(--fs-sm);line-height:1.45;color:#a3adc2;white-space:pre-wrap;}',
