...
def test_dashboard_pages_encode_inline_values(client, page, variable, param, value):
    ...
    if f"var {variable}" not in html:
        # The migration branch serves the compiled Vue MPA entry instead of
        # the legacy inline-injection template.
